...
-- SORU04: charles dickens ile şemsettin sami arasindaki yazarlari listeleyin
-- SORU05: sayfa sayisi 200 den buyuk kitap ismi 'beyaz dis' olan kitabin ismi puanini getir
-- SORU06: kitap no su 98 54 21 76 olan kitapno ve isimlerini listlele
-- SORU07: İsmi A harfi ile başlayan yazarlari listele
-- SORU08: İsminin 2. harfi E olan yazarlari listeleyin
-- SORU09: İsminin 2. harfi E olup diğer harflerinde Y olan yazar
-- SORU10: isim ilk harfi r ile baslasin ikini harfi ne olursa olsun icinde k harfi bulunan isimleri listele
-- SORU11: isminde a harfi olmayan isimleri listele.
-- SORU12: kitab adi 6 haneli olan kitablari listeleyin
-- SORU13: 1. harfi A ve 8. harfi A olan kitap listeleyin

1- SELECT * FROM kitap WHERE sayfasayisi > 200;
2- SELECT sayi FROM kitap WHERE yazarno = 33;
3- SELECT ad FROM yazar WHERE yazarno BETWEEN 4 AND 9;
4- SELECT ad,soyad FROM yazar WHERE ad BETWEEN 'Charles' AND 'Şemsettin';
5- SELECT puan FROM kitap WHERE sayfasayisi > 200 AND ad = 'Beyaz Diş';
6- SELECT ad,kitapno FROM kitap WHERE kitapno IN (98,54,21,76);
7- SELECT ad,soyad FROM yazar WHERE ad ~~ 'A%';
8- SELECT ad,soyad FROM yazar WHERE ad ~~ '_e%';
9- SELECT ad,soyad FROM yazar WHERE ad LIKE '_e%y%';
10- SELECT ad,soyad FROM yazar WHERE ad LIKE 'R%k%';
11- SELECT ad FROM yazar WHERE ad NOT ILIKE '%a%';
12- SELECT ad FROM kitap WHERE LENGTH(ad)=6 ;
13- SELECT ad FROM kitap WHERE ad LIKE 'A______a%';
